...
CHAIN_CASPER_MAINNET = 'casperMainnet'
CHAIN_CASPER_TESTNET = 'casperTestnet'
...
SYS_CHAIN_CASPER_MAINNET = 'casper_mainnet'
SYS_CHAIN_CASPER_TESTNET = 'casper_testnet'
...
class Chain(Enum):
    ...
    casper_mainnet = 6, BlockchainType.casper, CHAIN_CASPER_MAINNET
    casper_testnet = 7, BlockchainType.casper, CHAIN_CASPER_TESTNET
    ...
    def parse_from_chain(chain_string):
        ...
        elif chain_string == SYS_CHAIN_CASPER_MAINNET:
            return Chain.casper_mainnet
        elif chain_string == SYS_CHAIN_CASPER_TESTNET:
            return Chain.casper_testnet
        else:
    ...
    def parse_from_external_display_value(external_display_value):
        if external_display_value == CHAIN_BITCOIN_MAINNET:
            ...
            return Chain.ethereum_ropsten
        elif external_display_value == CHAIN_CASPER_MAINNET:
            return Chain.casper_mainnet
        elif external_display_value == CHAIN_CASPER_TESTNET:
            return Chain.casper_testnet
        else:
